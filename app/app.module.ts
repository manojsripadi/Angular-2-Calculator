...
import {SampleClass} from './Calculator';
 //import {HttpModule} from '@angular/http';
/*@NgModule({
...
@NgModule({
 ...
 AppRouterModule
  ...
  declarations:[AppComponent,EmployeeComponent1,EmployeeComponent2,components,SampleClass,sampleData,Metricstream,RadioClass],
  bootstrap :[AppComponent]
})
